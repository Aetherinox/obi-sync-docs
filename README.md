...
- If you are not concerned about the security, you can use the `DOCKER-COMPOSE.YML ONLY` option below.
- If you do want the extra security, skip below to `DOCKER-COMPOSE.YML + .ENV`
